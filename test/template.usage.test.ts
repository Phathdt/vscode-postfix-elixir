...
import {
  ...
  overrideTsxEnabled,
} from "../src/postfixCompletionProvider";
...
const testTemplateUsage =
  makeTestFunction<typeof __testTemplateUsage>(__testTemplateUsage);
...
describe.only("Template usage", () => {
  ...
  testTemplateUsage(
    "awaited expression",
    "await expr",
    _.difference(ALL_TEMPLATES, ["new", "await", "forin"])
  );
  testTemplateUsage(
    "method call expression",
    "expr.call()",
    _.difference(ALL_TEMPLATES, ["for", "new"])
  );
  testTemplateUsage("property access expression", "expr.a.b.c", ALL_TEMPLATES);
  testTemplateUsage(
    "element access expression",
    "expr.a.b[c]",
    _.difference(ALL_TEMPLATES, ["new"])
  );
  testTemplateUsage("binary expression", "x > y", BINARY_EXPRESSION_TEMPLATES);
  testTemplateUsage(
    "binary expression",
    "(x > y)",
    BINARY_EXPRESSION_TEMPLATES
  );
  testTemplateUsage(
    "unary expression",
    "expr++",
    _.difference(ALL_TEMPLATES, [...FOR_TEMPLATES, "new", "await"])
  );
  testTemplateUsage("conditional expression", "if (x * 100{cursor})", ["not"]);
  testTemplateUsage("return expression", "return x * 100", [
    ...CAST_TEMPLATES,
    "not",
    "call",
  ]);
  testTemplateUsage("object literal expression", "{}", [
    ...VAR_TEMPLATES,
    ...CONSOLE_TEMPLATES,
    "return",
  ]);
  testTemplateUsage("object literal expression", '{foo:"foo"}', [
    ...VAR_TEMPLATES,
    ...CONSOLE_TEMPLATES,
    "return",
  ]);
  testTemplateUsage("new expression", "new Class()", [
    ...VAR_TEMPLATES,
    ...CONSOLE_TEMPLATES,
    ...CAST_TEMPLATES,
    "return",
  ...
  testTemplateUsage(
    ...
    'function.call("arg", expr{cursor})',
    [...CAST_TEMPLATES, "not", "new", "await", "call"]
  );

  testTemplateUsage(
    "string literal - single quote",
    "'a string'",
    STRING_LITERAL_TEMPLATES
  );
  testTemplateUsage(
  ...
  testTemplateUsage(
    "string literal - backtick with var #1",
    "`a ${value} string`",
    STRING_LITERAL_TEMPLATES
  );
  testTemplateUsage(
    "string literal - backtick with var #2",
    "`a string ${value}`",
    STRING_LITERAL_TEMPLATES
  );
  ...
  testTemplateUsage(
    "inside return - arrow function",
    "return items.map(x => { result{cursor} })",
    ALL_TEMPLATES
  );
  testTemplateUsage(
    "inside return - function",
    "return items.map(function(x) { result{cursor} })",
    ALL_TEMPLATES
  );

  testTemplateUsage("inside variable declaration", "var test = expr{cursor}", [
    ...CAST_TEMPLATES,
    ...EQUALITY_TEMPLATES,
    "not",
    "await",
  ...
  testTemplateUsage("inside assignment statement", "test = expr{cursor}", [
    ...CAST_TEMPLATES,
    ...EQUALITY_TEMPLATES,
    "not",
    "call",
  ...
  testTemplateUsage(
    "inside assignment statement - short-circuit",
    "test *= expr{cursor}",
    [...CAST_TEMPLATES, ...EQUALITY_TEMPLATES, "not", "call"]
  );
  testTemplateUsage("inside return", "return expr{cursor}", [
    ...CAST_TEMPLATES,
    ...EQUALITY_TEMPLATES,
    "not",
    "await",
  ...
  testTemplateUsage(
    "inside var declaration - function",
    "const f1 = function () { expr{cursor}",
    ALL_TEMPLATES
  );
  testTemplateUsage(
    "inside var declaration - arrow function",
    "const f3 = () => { expr{cursor}",
    ALL_TEMPLATES
  );
  testTemplateUsage(
    "inside function",
    "function f2() { expr{cursor}",
    ALL_TEMPLATES
  );
  testTemplateUsage(
  ...
  testTemplateUsage(
    "cursor in wrong place #1",
    "test.something = {cursor-no-dot}",
    []
  );
  testTemplateUsage(
    "cursor in wrong place #2",
    "test.something = new{cursor-no-dot}",
    []
  );
  ...
  describe("when some templates are disabled", () => {
    ...
    testTemplateUsage(
      ...
      "expr",
      _.difference(ALL_TEMPLATES, ["var", "forof"])
    );
  });
});

function setDisabledTemplates(
...
function __testTemplateUsage(
  ...
  func(testDescription, (done: Mocha.Done) => {
    vsc.workspace.openTextDocument({ language: LANGUAGE }).then((doc) => {
      return getAvailableSuggestions(doc, initialText)
        .then((templates) => {
          assert.deepStrictEqual(
            _.sortBy(templates),
            _.sortBy(expectedTemplates)
          );
          done();
        })
